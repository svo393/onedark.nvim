local colors = {
    ...
    bg_yellow = { '#ebd09c', '#e8c88c' , '#f0d197' , '#f2cc81' , '#e6cfa1' , '#e2c792' },
           fg = { '#B1B8C6', '#a0a8b7' , '#a5b0c5' , '#93a4c3' , '#b1b4b9' , '#a7aab0' },
       purple = { '#D7A4F4', '#bf68d9' , '#ca72e4' , '#c75ae8' , '#c27fd7' , '#bb70d2' },
        green = { '#99C479', '#8ebd6b' , '#97ca72' , '#8bcd5b' , '#99bc80' , '#8fb573' },
       orange = { '#FFA077', '#cc9057' , '#d99a5e' , '#dd9046' , '#c99a6e' , '#c49060' },
         blue = { '#72BEFF', '#4fa6ed' , '#5ab0f6' , '#41a7fc' , '#68aee8' , '#57a5e5' },
       yellow = { '#D6B373', '#e2b86b' , '#ebc275' , '#efbd5d' , '#dfbe81' , '#dbb671' },
         cyan = { '#58C9C3', '#48b0bd' , '#4dbdcb' , '#34bfd0' , '#5fafb9' , '#51a8b3' },
          red = { '#FF9BA8', '#e55561' , '#ef5f6b' , '#f65866' , '#e16d77' , '#de5d68' },
